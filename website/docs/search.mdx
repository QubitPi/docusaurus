...
1. A [Squarespace domain](https://domains.squarespace.com/) (or any DNS-configurable domains owned)
2. A GitHub user/org site repository in the `<user>/<org>.github.io` format. Follow [this tutorial](https://pages.github.com/) to set one up if not yet.
...
8. You should now see a file entitled _CNAME_ containing your domain name.
...
![Error loading squarespace-dns.png](img/squarespace-dns.png)
